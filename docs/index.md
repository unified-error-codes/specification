...
| `EVSEID`        | ConnectorLockStateType | The EVSE identifier - the same one that the EVSE sends to the EV in the SessionSetupRes message. |
| `EVCCID`        | ConnectorLockStateType | The EVCC identifier - the same on that the EV sends to the EVSE in the SessionSetupReq message.  |
