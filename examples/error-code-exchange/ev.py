...
The link between EV and EVSE is ISO 15118-2's Event Notification
Protocol; this module stands in for it with a direct in-process call
that carries the same OER-encoded bytes (see the note on the 'coer'
codec substitution in common.py's caller, evse.py) that would cross
the wire.
"""
...
if __name__ == "__main__":
    ...
    print(f"EV -> EVSE over ISO 15118-2 ({len(wire_bytes)} bytes):")
